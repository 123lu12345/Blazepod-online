...
def start_game(data):
    ...
    blink_limit = int(data.get("blinkCount", 0))
    end_mode = data.get("endMode", "time")
    blink_counter = 0
    ...
    def game_loop():
        ...
        while (end_mode == "time" and time.time() < end_time) or (end_mode == "blinks" and blink_counter < blink_limit):
